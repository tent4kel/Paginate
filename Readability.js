...
Readability.prototype = {
  ...
  REGEXPS: {
    ...
    unlikelyCandidates: /-ad-|player|ai2html|banner|breadcrumbs|combx|comment|community|cover-wrap|disqus|extra|footer|gdpr|header|legends|menu|related|remark|replies|rssplayer|recommended|shoutbox|sidebar|skyscraper|social|sponsor|supplemental|ad-break|agegate|pagination|pager|popup|yom-remote/i,
    okMaybeItsACandidate: /and|article|body|column|content|headerImage|main|shadow/i,

    positive: /article|article-image|artikel|body|content|entry|hero|hentry|h-entry|main|page|pagination|post|text|blog|story/i,
    negative: /-ad-|anzeige|hidden|^hid$| hid$| hid |^hid |banner|combx|comment|com-|contact|content-box|foot|feature-bar|footer|footnote|gdpr|masthead|media|meta|outbrain|promo|related|scroll|share|shoutbox|sidebar|skyscraper|sponsor|shopping|tags|tool|widget/i,
  ...
  PRESENTATIONAL_ATTRIBUTES: [ "align", "background", "border", "cellpadding", "cellspacing", "frame", "hspace", "rules", "style", "valign", "vspace" ],
